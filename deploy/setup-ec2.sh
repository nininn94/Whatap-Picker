...
echo "  3) GitHub repo Settings → Secrets and variables → Actions 에 다음 등록:"
echo "       EC2_HOST, EC2_USER, EC2_SSH_KEY,"
echo "       JWT_SECRET, BOOTSTRAP_ADMIN_USERNAME, BOOTSTRAP_ADMIN_PASSWORD,"
echo "       POSTGRES_PASSWORD, APP_PUBLIC_BASE_URL"
echo "     (자세한 값 생성법은 DEPLOYMENT.md 참고)"
